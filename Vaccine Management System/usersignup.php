...
$stmt = $conn->prepare("insert into user(`full name`, `Smartcard/Employee Id.`, `Email Address`, `Password`, `Phone number`) values('$Name', '$smartcardid', '$email', '$password', '$phone')");
...
<body>
    <p><img class="image21" src="images/01.jpg">
        <a href="userlogin.html" class="p2"><input type="submit" value="Back"></a>
    </p>
  <section class="login-form-wraps">
  <h1 style="color: white;" ><b>Signup Form</b></h1>
  <h1 style="color: white;" ><b>User</b></h1>
